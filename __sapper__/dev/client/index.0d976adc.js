...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file$1, 38, 2, 949);
			...
			add_location(button, file$1, 40, 2, 1030);
			attr_dev(div, "class", "btns svelte-1ernrbq");
			add_location(div, file$1, 39, 2, 1009);
