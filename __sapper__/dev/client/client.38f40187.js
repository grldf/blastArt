...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 43, 1, 539);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 38, 0, 470);
			attr_dev(p, "class", "svelte-6jdhpp");
			add_location(p, file, 40, 0, 489);
...
const components = [
	{
		js: () => Promise.all([import('./index.e10c7c65.js'), __inject_styles(["client-5088e28a.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.408c1611.js'), __inject_styles(["client-5088e28a.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a8abab0d.js'), __inject_styles(["client-5088e28a.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a21264af.js'), __inject_styles(["client-5088e28a.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bfd7ceda.js'), __inject_styles(["client-5088e28a.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8ac748c0.js'), __inject_styles(["client-5088e28a.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].6ab4882b.js'), __inject_styles(["client-5088e28a.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b422ddaa.js'), __inject_styles(["client-5088e28a.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c7b36946.js'), __inject_styles(["client-5088e28a.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.90b7d5e0.js'), __inject_styles(["client-5088e28a.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c50a75bd.js'), __inject_styles(["client-5088e28a.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
