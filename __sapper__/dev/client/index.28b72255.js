...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 59, 10, 1671);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-v8q2la");
			add_location(img, file, 57, 10, 1601);
		},
		m: function mount(target, anchor) {
			insert_dev(target, img, anchor);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 52, 8, 1461);
			attr_dev(p, "class", "svelte-v8q2la");
			add_location(p, file, 53, 8, 1493);
			attr_dev(article, "class", "svelte-v8q2la");
			add_location(article, file, 51, 6, 1443);
			attr_dev(div, "class", "impair svelte-v8q2la");
			add_location(div, file, 50, 4, 1416);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 67, 6, 1843);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(meta, file, 42, 2, 951);
			...
			add_location(link, file, 46, 2, 1278);
			attr_dev(br, "class", "last-br svelte-v8q2la");
			add_location(br, file, 64, 2, 1785);
			attr_dev(div, "class", "content svelte-v8q2la");
			add_location(div, file, 48, 0, 1362);
		},
		m: function mount(target, anchor) {
