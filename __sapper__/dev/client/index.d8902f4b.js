...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 41, 4, 1020);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 43, 6, 1170);
			...
			add_location(video, file, 42, 4, 1047);
			add_location(div, file, 40, 0, 1010);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				...
				title: "Vidéos présentant le travail du collectif, à travers de "
			},
			$$inline: true
		});
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 37, 0, 961);
		},
		m: function mount(target, anchor) {
