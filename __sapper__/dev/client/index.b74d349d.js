...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 947);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1097);
			...
			add_location(video, file, 41, 4, 974);
			add_location(div, file, 39, 0, 937);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				description: "Le collectif Blast art vous amènes à voyager  ",
