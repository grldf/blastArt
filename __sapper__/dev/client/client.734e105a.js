...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-l32bkw");
			add_location(h1, file, 31, 1, 427);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-l32bkw");
			add_location(img, file, 32, 1, 441);
			attr_dev(div, "class", "container svelte-l32bkw");
			add_location(div, file, 30, 0, 402);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.c3f5890b.js'), __inject_styles(["client-391522c7.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f5d6dbdd.js'), __inject_styles(["client-391522c7.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ab82d12d.js'), __inject_styles(["client-391522c7.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.15e1d3d1.js'), __inject_styles(["client-391522c7.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.dbd1cee9.js'), __inject_styles(["client-391522c7.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.32c72fbd.js'), __inject_styles(["client-391522c7.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].b17b8213.js'), __inject_styles(["client-391522c7.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ff02b934.js'), __inject_styles(["client-391522c7.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2c8e6ec8.js'), __inject_styles(["client-391522c7.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7103fc4d.js'), __inject_styles(["client-391522c7.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.adcd4be6.js'), __inject_styles(["client-391522c7.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
