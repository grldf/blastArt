...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 915);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1065);
			...
			add_location(video, file, 41, 4, 942);
			add_location(div, file, 39, 0, 905);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 856);
		},
		m: function mount(target, anchor) {
