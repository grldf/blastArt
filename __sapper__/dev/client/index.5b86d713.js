...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file, 34, 4, 703);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 36, 8, 840);
			...
			add_location(video, file, 35, 4, 730);
			add_location(div, file, 33, 0, 693);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 31, 0, 645);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
