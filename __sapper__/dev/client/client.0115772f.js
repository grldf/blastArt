...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-xjenkp");
			add_location(img, file, 28, 1, 408);
			add_location(h1, file, 27, 1, 401);
			attr_dev(div, "class", "container svelte-xjenkp");
			add_location(div, file, 26, 0, 376);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.09b27865.js'), __inject_styles(["client-fd50fe4b.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.00560dfa.js'), __inject_styles(["client-fd50fe4b.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.283b1bd4.js'), __inject_styles(["client-fd50fe4b.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7f24ff83.js'), __inject_styles(["client-fd50fe4b.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3dcd4144.js'), __inject_styles(["client-fd50fe4b.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1aead1b5.js'), __inject_styles(["client-fd50fe4b.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].280c60e3.js'), __inject_styles(["client-fd50fe4b.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e6fdcb5b.js'), __inject_styles(["client-fd50fe4b.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.86f636d1.js'), __inject_styles(["client-fd50fe4b.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d8d96fd0.js'), __inject_styles(["client-fd50fe4b.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e0ef9545.js'), __inject_styles(["client-fd50fe4b.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
