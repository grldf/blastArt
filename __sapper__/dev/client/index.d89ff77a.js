...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 951);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1101);
			...
			add_location(video, file, 41, 4, 978);
			add_location(div, file, 39, 0, 941);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 892);
		},
		m: function mount(target, anchor) {
