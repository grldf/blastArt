...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button0, "class", "snipcart-customer-signin svelte-13367f");
			add_location(button0, file$8, 139, 6, 6604);
			add_location(metadata, file$8, 149, 10, 6956);
			...
			add_location(path0, file$8, 157, 12, 7234);
			...
			add_location(path1, file$8, 211, 12, 11367);
			...
			add_location(svg, file$8, 141, 9, 6705);
			attr_dev(button1, "class", "snipcart-checkout svelte-13367f");
			add_location(button1, file$8, 140, 6, 6662);
			attr_dev(span0, "class", "snipcart-items-count");
			add_location(span0, file$8, 224, 19, 11847);
			add_location(br, file$8, 224, 56, 11884);
			attr_dev(span1, "class", "snipcart-total-price");
			add_location(span1, file$8, 225, 15, 11906);
			attr_dev(p, "class", "info-prix svelte-13367f");
			add_location(p, file$8, 223, 6, 11806);
...
function create_default_slot$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a7, file$8, 265, 4, 13040);
			...
			add_location(a8, file$8, 270, 4, 13170);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.1377d014.js'), __inject_styles(["client-e49779fb.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.054cc51e.js'), __inject_styles(["client-e49779fb.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.eefb585d.js'), __inject_styles(["client-e49779fb.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.384b3fd5.js'), __inject_styles(["client-e49779fb.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b41bb712.js'), __inject_styles(["client-e49779fb.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.096928bf.js'), __inject_styles(["client-e49779fb.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].7213f070.js'), __inject_styles(["client-e49779fb.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b3c894d8.js'), __inject_styles(["client-e49779fb.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.555ad6a4.js'), __inject_styles(["client-e49779fb.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.88cad7b9.js'), __inject_styles(["client-e49779fb.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.71f949fb.js'), __inject_styles(["client-e49779fb.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
