import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, l as children, b as detach_dev, f as claim_space, m as claim_text, g as attr_dev, h as add_location, y as toggle_class, k as insert_dev, j as append_dev, w as set_data_dev, n as noop, r as validate_each_argument, F as create_component, G as claim_component, I as mount_component, B as transition_in, C as transition_out, J as destroy_component, q as query_selector_all, A as listen_dev, D as check_outros, x as destroy_each, E as run_all, K as group_outros } from './client.2002abe1.js';
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ("slideNo" in $$props) $$invalidate(5, slideNo = $$props.slideNo);
		if ("totalSlide" in $$props) $$invalidate(6, totalSlide = $$props.totalSlide);
	...
	return [imageUrl, alternText, imageShowing, infos, slug, slideNo, totalSlide];
}
...
class Slide extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*slideNo*/ ctx[5] === undefined && !("slideNo" in props)) {
			console.warn("<Slide> was created without expected prop 'slideNo'");
		}

		if (/*totalSlide*/ ctx[6] === undefined && !("totalSlide" in props)) {
