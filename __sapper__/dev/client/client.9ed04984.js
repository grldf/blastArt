...
const components = [
	{
		js: () => Promise.all([import('./index.f16e5919.js'), __inject_styles(["client-ba589e00.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.01550542.js'), __inject_styles(["client-ba589e00.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.915dfaa1.js'), __inject_styles(["client-ba589e00.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.077076c8.js'), __inject_styles(["client-ba589e00.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3d45e37e.js'), __inject_styles(["client-ba589e00.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5dc10965.js'), __inject_styles(["client-ba589e00.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].e3b55c88.js'), __inject_styles(["client-ba589e00.css","[slug]-af9b0efe.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8033b443.js'), __inject_styles(["client-ba589e00.css","index-f53b6465.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b664a851.js'), __inject_styles(["client-ba589e00.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.aa465625.js'), __inject_styles(["client-ba589e00.css","index-f8e35049.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.824d7764.js'), __inject_styles(["client-ba589e00.css","index-4525c145.css"])]).then(function(x) { return x[0]; })
	}
];
