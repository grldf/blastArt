...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option1, file$1, 29, 6, 648);
			option2.__value = "cat";
			option2.value = option2.__value;
			add_location(option2, file$1, 30, 6, 687);
			option3.__value = "hamster";
			option3.value = option3.__value;
			add_location(option3, file$1, 31, 6, 726);
			option4.__value = "parrot";
			option4.value = option4.__value;
			add_location(option4, file$1, 32, 6, 773);
			option5.__value = "spider";
			option5.value = option5.__value;
			add_location(option5, file$1, 33, 6, 818);
			option6.__value = "goldfish";
			option6.value = option6.__value;
			add_location(option6, file$1, 34, 6, 863);
			...
			add_location(img, file$1, 38, 2, 933);
			...
			add_location(button, file$1, 40, 2, 1014);
			attr_dev(div, "class", "btns svelte-1ernrbq");
			add_location(div, file$1, 39, 2, 993);
