...
const components = [
	{
		js: () => Promise.all([import('./index.c46487c6.js'), __inject_styles(["client-c5e072b2.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.de55da26.js'), __inject_styles(["client-c5e072b2.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7a740a72.js'), __inject_styles(["client-c5e072b2.css","index-5d8e9dde.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.cf7cd2ff.js'), __inject_styles(["client-c5e072b2.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2b0463f3.js'), __inject_styles(["client-c5e072b2.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fae25981.js'), __inject_styles(["client-c5e072b2.css","index-b9bc9bdd.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].698a0dc4.js'), __inject_styles(["client-c5e072b2.css","[slug]-868e980e.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8b164646.js'), __inject_styles(["client-c5e072b2.css","index-f53b6465.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1ac8bb59.js'), __inject_styles(["client-c5e072b2.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.714a0d5d.js'), __inject_styles(["client-c5e072b2.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3d04ea4a.js'), __inject_styles(["client-c5e072b2.css","index-e437e08e.css"])]).then(function(x) { return x[0]; })
	}
];
