...
const components = [
	{
		js: () => Promise.all([import('./index.1a455c37.js'), __inject_styles(["client-51699124.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4a5ba1f2.js'), __inject_styles(["client-51699124.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bd973d88.js'), __inject_styles(["client-51699124.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b26e17d9.js'), __inject_styles(["client-51699124.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.eb3814cf.js'), __inject_styles(["client-51699124.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2442f342.js'), __inject_styles(["client-51699124.css","index-8bbba276.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].900becd6.js'), __inject_styles(["client-51699124.css","[slug]-9c4235b2.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ed1c576f.js'), __inject_styles(["client-51699124.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.77dd6493.js'), __inject_styles(["client-51699124.css","index-8c1d5cad.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.656d5413.js'), __inject_styles(["client-51699124.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ff70ba2e.js'), __inject_styles(["client-51699124.css","index-a454d6d5.css"])]).then(function(x) { return x[0]; })
	}
];
