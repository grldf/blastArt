...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1xacmaf");
			add_location(h1, file, 29, 1, 411);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-1xacmaf");
			add_location(img, file, 30, 1, 425);
			attr_dev(div, "class", "container svelte-1xacmaf");
			add_location(div, file, 28, 0, 386);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.3918b1fc.js'), __inject_styles(["client-7a420229.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4f4dae1f.js'), __inject_styles(["client-7a420229.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d098b878.js'), __inject_styles(["client-7a420229.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.67e30e53.js'), __inject_styles(["client-7a420229.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6a65ffa2.js'), __inject_styles(["client-7a420229.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7511f49c.js'), __inject_styles(["client-7a420229.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].08580eee.js'), __inject_styles(["client-7a420229.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.004a4d9e.js'), __inject_styles(["client-7a420229.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.32ed806f.js'), __inject_styles(["client-7a420229.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ef0c3451.js'), __inject_styles(["client-7a420229.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.af391af9.js'), __inject_styles(["client-7a420229.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
