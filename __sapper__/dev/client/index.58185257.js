import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as attr_dev, k as add_location, l as toggle_class, m as insert_dev, n as append_dev, o as set_data_dev, p as noop, q as validate_each_argument, r as create_component, u as claim_component, w as mount_component, x as transition_in, y as transition_out, z as destroy_component, A as query_selector_all, B as listen_dev, C as check_outros, D as destroy_each, E as run_all, F as group_outros } from './client.12d538f8.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "numbertext svelte-zzdqev");
			...
			attr_dev(img, "class", "svelte-zzdqev");
			add_location(img, file, 11, 4, 306);
			attr_dev(a, "href", /*slug*/ ctx[6]);
			attr_dev(a, "class", "link svelte-zzdqev");
			add_location(a, file, 13, 9, 380);
			attr_dev(p, "class", "svelte-zzdqev");
			add_location(p, file, 13, 6, 377);
			attr_dev(div1, "class", "infos svelte-zzdqev");
			add_location(div1, file, 12, 4, 351);
			attr_dev(div2, "class", "mySlides svelte-zzdqev");
