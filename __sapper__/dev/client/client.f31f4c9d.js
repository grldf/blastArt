...
const components = [
	{
		js: () => Promise.all([import('./index.9f6f51b7.js'), __inject_styles(["client-47bb6c42.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.899cf116.js'), __inject_styles(["client-47bb6c42.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.150eef9c.js'), __inject_styles(["client-47bb6c42.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.58b48c1d.js'), __inject_styles(["client-47bb6c42.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.60224d95.js'), __inject_styles(["client-47bb6c42.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.331c8965.js'), __inject_styles(["client-47bb6c42.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].530b7181.js'), __inject_styles(["client-47bb6c42.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a80f396e.js'), __inject_styles(["client-47bb6c42.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6157c5f8.js'), __inject_styles(["client-47bb6c42.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.93b5fbce.js'), __inject_styles(["client-47bb6c42.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7a9d9618.js'), __inject_styles(["client-47bb6c42.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
