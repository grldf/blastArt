...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 50, 1, 699);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-19v3e61");
			add_location(img, file, 44, 1, 565);
			attr_dev(h1, "class", "svelte-19v3e61");
			add_location(h1, file, 45, 0, 630);
			attr_dev(p, "class", "svelte-19v3e61");
			add_location(p, file, 47, 0, 649);
			attr_dev(div, "class", "container svelte-19v3e61");
			add_location(div, file, 43, 0, 540);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.8df31d47.js'), __inject_styles(["client-8fd6d345.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4468d793.js'), __inject_styles(["client-8fd6d345.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.50b457f4.js'), __inject_styles(["client-8fd6d345.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f4e9fb34.js'), __inject_styles(["client-8fd6d345.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fde899de.js'), __inject_styles(["client-8fd6d345.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b0191ed0.js'), __inject_styles(["client-8fd6d345.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].b047566c.js'), __inject_styles(["client-8fd6d345.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e677a5ff.js'), __inject_styles(["client-8fd6d345.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e6d20e53.js'), __inject_styles(["client-8fd6d345.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b9f695d9.js'), __inject_styles(["client-8fd6d345.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.da0bc8a0.js'), __inject_styles(["client-8fd6d345.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
