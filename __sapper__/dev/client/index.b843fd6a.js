...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 41, 4, 1073);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 43, 6, 1223);
			...
			add_location(video, file, 42, 4, 1100);
			add_location(div, file, 40, 0, 1063);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 37, 0, 1014);
		},
		m: function mount(target, anchor) {
