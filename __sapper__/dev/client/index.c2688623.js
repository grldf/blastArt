...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 42, 8, 982);
			attr_dev(p, "class", "svelte-1nqn5kh");
			add_location(p, file, 43, 8, 1010);
			attr_dev(article, "class", "svelte-1nqn5kh");
			add_location(article, file, 41, 6, 964);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(link, file, 35, 4, 769);
			attr_dev(div, "class", "content svelte-1nqn5kh");
			add_location(div, file, 38, 2, 860);
		},
		m: function mount(target, anchor) {
