...
function create_fragment$1(ctx) {
	...
	let span;
	let t4;
	let t5_value = /*prixProduit*/ ctx[2] + parseselected + "";
	let t5;
	let t6;
	let t7;
	let select;
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if ((!current || dirty & /*prixProduit*/ 4) && t5_value !== (t5_value = /*prixProduit*/ ctx[2] + parseselected + "")) set_data_dev(t5, t5_value);
