...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 41, 4, 1047);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 43, 6, 1197);
			...
			add_location(video, file, 42, 4, 1074);
			add_location(div, file, 40, 0, 1037);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 37, 0, 988);
		},
		m: function mount(target, anchor) {
