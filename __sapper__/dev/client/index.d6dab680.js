...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 929);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1079);
			...
			add_location(video, file, 41, 4, 956);
			add_location(div, file, 39, 0, 919);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				description: "Retrouvez toutes les vidéos ",
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 870);
		},
		m: function mount(target, anchor) {
