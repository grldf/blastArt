...
const components = [
	{
		js: () => Promise.all([import('./index.b68068e7.js'), __inject_styles(["client-51699124.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.88a57d72.js'), __inject_styles(["client-51699124.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.cbb0450a.js'), __inject_styles(["client-51699124.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.104b404c.js'), __inject_styles(["client-51699124.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.02692620.js'), __inject_styles(["client-51699124.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.66e42c0e.js'), __inject_styles(["client-51699124.css","index-8bbba276.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].2e0aa2b7.js'), __inject_styles(["client-51699124.css","[slug]-9c4235b2.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4801665d.js'), __inject_styles(["client-51699124.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.29c21cc6.js'), __inject_styles(["client-51699124.css","index-8c1d5cad.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a98b4af3.js'), __inject_styles(["client-51699124.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.04398f91.js'), __inject_styles(["client-51699124.css","index-a89e385a.css"])]).then(function(x) { return x[0]; })
	}
];
