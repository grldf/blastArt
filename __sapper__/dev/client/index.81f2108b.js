...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(link, file, 35, 4, 787);
			attr_dev(div, "class", "content svelte-1nqn5kh");
			add_location(div, file, 38, 2, 878);
		},
		m: function mount(target, anchor) {
