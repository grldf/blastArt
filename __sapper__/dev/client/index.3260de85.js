...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 933);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1083);
			...
			add_location(video, file, 41, 4, 960);
			add_location(div, file, 39, 0, 923);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				description: "Le collectif Blast art vous amè ",
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 874);
		},
		m: function mount(target, anchor) {
