...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 74, 2, 2278);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 55, 2, 1881);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 59, 8, 2003);
			attr_dev(p, "class", "svelte-12psx4l");
			add_location(p, file, 60, 8, 2031);
			attr_dev(article, "class", "svelte-12psx4l");
			add_location(article, file, 58, 6, 1985);
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				...
				title: "Portrait des différents membres du collefif Blast Art. Kalouf peintre  ",
				openGraph: {
					type: "article",
