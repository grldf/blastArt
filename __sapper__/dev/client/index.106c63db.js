...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 74, 2, 2317);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 55, 2, 1920);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 59, 8, 2042);
			attr_dev(p, "class", "svelte-12psx4l");
			add_location(p, file, 60, 8, 2070);
			attr_dev(article, "class", "svelte-12psx4l");
			add_location(article, file, 58, 6, 2024);
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				...
				title: "Portrait des différents membres du collefif Blast Art. Kalouf peintre muraliste, Romain Lardanchet sculpteur  ",
				openGraph: {
					type: "article",
