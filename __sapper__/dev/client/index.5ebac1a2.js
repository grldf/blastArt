...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option3, file$1, 31, 6, 740);
			option4.__value = "110";
			option4.value = option4.__value;
			add_location(option4, file$1, 32, 6, 783);
			option5.__value = "110";
			option5.value = option5.__value;
			add_location(option5, file$1, 33, 6, 825);
			option6.__value = "110";
			option6.value = option6.__value;
			add_location(option6, file$1, 34, 6, 867);
			...
			add_location(img, file$1, 38, 2, 932);
			...
			add_location(button, file$1, 40, 2, 1013);
			attr_dev(div, "class", "btns svelte-1ernrbq");
			add_location(div, file$1, 39, 2, 992);
