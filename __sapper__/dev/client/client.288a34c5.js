...
const components = [
	{
		js: () => Promise.all([import('./index.20a69ec1.js'), __inject_styles(["client-51699124.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.75c00e72.js'), __inject_styles(["client-51699124.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.81a9179b.js'), __inject_styles(["client-51699124.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6c2a833f.js'), __inject_styles(["client-51699124.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.78595a1e.js'), __inject_styles(["client-51699124.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.49ad1289.js'), __inject_styles(["client-51699124.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].6e36338c.js'), __inject_styles(["client-51699124.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b9525b80.js'), __inject_styles(["client-51699124.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e164c4e4.js'), __inject_styles(["client-51699124.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e2e74a47.js'), __inject_styles(["client-51699124.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fd03d433.js'), __inject_styles(["client-51699124.css","index-263d96d0.css"])]).then(function(x) { return x[0]; })
	}
];
