...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 43, 1, 540);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 38, 0, 471);
			attr_dev(p, "class", "svelte-6jdhpp");
			add_location(p, file, 40, 0, 490);
...
const components = [
	{
		js: () => Promise.all([import('./index.9affcfba.js'), __inject_styles(["client-5088e28a.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fef81bc7.js'), __inject_styles(["client-5088e28a.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.58a04ad5.js'), __inject_styles(["client-5088e28a.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.15cf74d3.js'), __inject_styles(["client-5088e28a.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d8717f66.js'), __inject_styles(["client-5088e28a.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b0c04c87.js'), __inject_styles(["client-5088e28a.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].c5c0bbac.js'), __inject_styles(["client-5088e28a.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bf9877de.js'), __inject_styles(["client-5088e28a.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9c2a56b2.js'), __inject_styles(["client-5088e28a.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4124556a.js'), __inject_styles(["client-5088e28a.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3c5c06c6.js'), __inject_styles(["client-5088e28a.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
