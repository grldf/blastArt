...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 27, 1, 386);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			add_location(img, file, 28, 1, 400);
			attr_dev(div, "class", "container svelte-1im4taf");
			add_location(div, file, 26, 0, 361);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.4698dfcc.js'), __inject_styles(["client-4ba8ba38.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3da04627.js'), __inject_styles(["client-4ba8ba38.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e4ca0957.js'), __inject_styles(["client-4ba8ba38.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9ec27ce1.js'), __inject_styles(["client-4ba8ba38.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.844247f8.js'), __inject_styles(["client-4ba8ba38.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.da7a213f.js'), __inject_styles(["client-4ba8ba38.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].d8790cc2.js'), __inject_styles(["client-4ba8ba38.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ace94b86.js'), __inject_styles(["client-4ba8ba38.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.87b063f9.js'), __inject_styles(["client-4ba8ba38.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1fdf1980.js'), __inject_styles(["client-4ba8ba38.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4a3a217a.js'), __inject_styles(["client-4ba8ba38.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
