...
const components = [
	{
		js: () => Promise.all([import('./index.63ff2b13.js'), __inject_styles(["client-c5e072b2.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.241a9e00.js'), __inject_styles(["client-c5e072b2.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a109ab60.js'), __inject_styles(["client-c5e072b2.css","index-5d8e9dde.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c9483f15.js'), __inject_styles(["client-c5e072b2.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ef498a34.js'), __inject_styles(["client-c5e072b2.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ea1deb1a.js'), __inject_styles(["client-c5e072b2.css","index-e0a33ecf.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].95458377.js'), __inject_styles(["client-c5e072b2.css","[slug]-868e980e.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.25f266dd.js'), __inject_styles(["client-c5e072b2.css","index-f53b6465.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9676f933.js'), __inject_styles(["client-c5e072b2.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fc00a2e3.js'), __inject_styles(["client-c5e072b2.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.272c1bb8.js'), __inject_styles(["client-c5e072b2.css","index-e437e08e.css"])]).then(function(x) { return x[0]; })
	}
];
