...
const components = [
	{
		js: () => Promise.all([import('./index.5c0f7d85.js'), __inject_styles(["client-c5e072b2.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.942f547b.js'), __inject_styles(["client-c5e072b2.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.617192bf.js'), __inject_styles(["client-c5e072b2.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f46744c8.js'), __inject_styles(["client-c5e072b2.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a52754ae.js'), __inject_styles(["client-c5e072b2.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2da31e18.js'), __inject_styles(["client-c5e072b2.css","index-5dafdbbd.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].2196e8cf.js'), __inject_styles(["client-c5e072b2.css","[slug]-a48d5e49.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4a76067c.js'), __inject_styles(["client-c5e072b2.css","index-48f95a55.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5a7bbaee.js'), __inject_styles(["client-c5e072b2.css","index-0f10ce34.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.499ae9a0.js'), __inject_styles(["client-c5e072b2.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.91708945.js'), __inject_styles(["client-c5e072b2.css","index-e437e08e.css"])]).then(function(x) { return x[0]; })
	}
];
