...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option4, file$1, 32, 6, 779);
			option5.__value = "110";
			option5.value = option5.__value;
			add_location(option5, file$1, 33, 6, 819);
			option6.__value = "110";
			option6.value = option6.__value;
			add_location(option6, file$1, 34, 6, 861);
			...
			add_location(img, file$1, 38, 2, 926);
			...
			add_location(button, file$1, 40, 2, 1007);
			attr_dev(div, "class", "btns svelte-1ernrbq");
			add_location(div, file$1, 39, 2, 986);
