...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 43, 1, 543);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 38, 0, 474);
			attr_dev(p, "class", "svelte-6jdhpp");
			add_location(p, file, 40, 0, 493);
...
const components = [
	{
		js: () => Promise.all([import('./index.85a30095.js'), __inject_styles(["client-5088e28a.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4c381878.js'), __inject_styles(["client-5088e28a.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.aeca4576.js'), __inject_styles(["client-5088e28a.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9ac8fa4c.js'), __inject_styles(["client-5088e28a.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.83cb9513.js'), __inject_styles(["client-5088e28a.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ec76a33f.js'), __inject_styles(["client-5088e28a.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].8719f920.js'), __inject_styles(["client-5088e28a.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8b3aa0a8.js'), __inject_styles(["client-5088e28a.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2b7459dd.js'), __inject_styles(["client-5088e28a.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.24b51fe8.js'), __inject_styles(["client-5088e28a.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d88f67df.js'), __inject_styles(["client-5088e28a.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
