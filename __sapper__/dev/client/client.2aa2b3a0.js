...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 50, 1, 701);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-phxo84");
			add_location(img, file, 44, 1, 567);
			attr_dev(h1, "class", "svelte-phxo84");
			add_location(h1, file, 45, 0, 632);
			attr_dev(p, "class", "svelte-phxo84");
			add_location(p, file, 47, 0, 651);
			attr_dev(div, "class", "container svelte-phxo84");
			add_location(div, file, 43, 0, 542);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.2a6f9c81.js'), __inject_styles(["client-05ec8d2c.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.86d0e6eb.js'), __inject_styles(["client-05ec8d2c.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ad137699.js'), __inject_styles(["client-05ec8d2c.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0d914b7d.js'), __inject_styles(["client-05ec8d2c.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.de00d615.js'), __inject_styles(["client-05ec8d2c.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.53ac0ccf.js'), __inject_styles(["client-05ec8d2c.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].cbd77bbc.js'), __inject_styles(["client-05ec8d2c.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1d50445c.js'), __inject_styles(["client-05ec8d2c.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c355da7b.js'), __inject_styles(["client-05ec8d2c.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.eca71a70.js'), __inject_styles(["client-05ec8d2c.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fa4f91b6.js'), __inject_styles(["client-05ec8d2c.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
