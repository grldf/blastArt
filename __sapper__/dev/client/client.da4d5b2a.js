...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1x6dxkm");
			add_location(h1, file, 32, 1, 455);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-1x6dxkm");
			add_location(img, file, 33, 1, 469);
			attr_dev(div, "class", "container svelte-1x6dxkm");
			add_location(div, file, 31, 0, 430);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.ea7ddcfb.js'), __inject_styles(["client-a34a5ba9.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.37a98752.js'), __inject_styles(["client-a34a5ba9.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0498a118.js'), __inject_styles(["client-a34a5ba9.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.39c82b23.js'), __inject_styles(["client-a34a5ba9.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.44f60515.js'), __inject_styles(["client-a34a5ba9.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9cf2ba39.js'), __inject_styles(["client-a34a5ba9.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].ad061bca.js'), __inject_styles(["client-a34a5ba9.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e02e25cb.js'), __inject_styles(["client-a34a5ba9.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d5905eee.js'), __inject_styles(["client-a34a5ba9.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f8d9ed3f.js'), __inject_styles(["client-a34a5ba9.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e84e3fb5.js'), __inject_styles(["client-a34a5ba9.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
