...
const components = [
	{
		js: () => Promise.all([import('./index.77eae691.js'), __inject_styles(["client-c5e072b2.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3142026d.js'), __inject_styles(["client-c5e072b2.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.48f29180.js'), __inject_styles(["client-c5e072b2.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6201d3fe.js'), __inject_styles(["client-c5e072b2.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.30efc174.js'), __inject_styles(["client-c5e072b2.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5b7d8003.js'), __inject_styles(["client-c5e072b2.css","index-5dafdbbd.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].ab1a7111.js'), __inject_styles(["client-c5e072b2.css","[slug]-a48d5e49.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.09195fa6.js'), __inject_styles(["client-c5e072b2.css","index-48f95a55.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a1a9af9d.js'), __inject_styles(["client-c5e072b2.css","index-f8ba0e58.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6164726d.js'), __inject_styles(["client-c5e072b2.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.156a5207.js'), __inject_styles(["client-c5e072b2.css","index-e437e08e.css"])]).then(function(x) { return x[0]; })
	}
];
