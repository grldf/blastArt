...
const components = [
	{
		js: () => Promise.all([import('./index.78d4fc20.js'), __inject_styles(["client-51699124.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b598f44d.js'), __inject_styles(["client-51699124.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0756f1a3.js'), __inject_styles(["client-51699124.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b51feaa7.js'), __inject_styles(["client-51699124.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.dd24f9a5.js'), __inject_styles(["client-51699124.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.708075dc.js'), __inject_styles(["client-51699124.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].c91f8872.js'), __inject_styles(["client-51699124.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5d4b8e66.js'), __inject_styles(["client-51699124.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.796aa710.js'), __inject_styles(["client-51699124.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c5a05836.js'), __inject_styles(["client-51699124.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.47001598.js'), __inject_styles(["client-51699124.css","index-263d96d0.css"])]).then(function(x) { return x[0]; })
	}
];
