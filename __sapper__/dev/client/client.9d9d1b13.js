...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button1, file$8, 223, 8, 11774);
			attr_dev(span0, "class", "snipcart-items-count");
			add_location(span0, file$8, 224, 19, 11854);
			add_location(br, file$8, 224, 56, 11891);
			attr_dev(span1, "class", "snipcart-total-price");
			add_location(span1, file$8, 225, 15, 11913);
			attr_dev(p, "class", "info-prix svelte-8ktzfm");
			add_location(p, file$8, 222, 6, 11744);
...
function create_default_slot$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a7, file$8, 265, 4, 13047);
			...
			add_location(a8, file$8, 270, 4, 13177);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.a3c4c409.js'), __inject_styles(["client-c8a0415d.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.84c562b6.js'), __inject_styles(["client-c8a0415d.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c5b973c3.js'), __inject_styles(["client-c8a0415d.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ec16dc6b.js'), __inject_styles(["client-c8a0415d.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a0705530.js'), __inject_styles(["client-c8a0415d.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.42c2164b.js'), __inject_styles(["client-c8a0415d.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].559b4aff.js'), __inject_styles(["client-c8a0415d.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3d6b88eb.js'), __inject_styles(["client-c8a0415d.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3b8776dc.js'), __inject_styles(["client-c8a0415d.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4bafd240.js'), __inject_styles(["client-c8a0415d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fe84120b.js'), __inject_styles(["client-c8a0415d.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
