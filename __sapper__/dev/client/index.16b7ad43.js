...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 41, 4, 1006);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 43, 6, 1156);
			...
			add_location(video, file, 42, 4, 1033);
			add_location(div, file, 40, 0, 996);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 37, 0, 947);
		},
		m: function mount(target, anchor) {
