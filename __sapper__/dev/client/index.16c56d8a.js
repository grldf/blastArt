...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-8jfc9m");
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-8jfc9m");
			add_location(h2, file, 49, 8, 1288);
			attr_dev(p, "class", "svelte-8jfc9m");
			add_location(p, file, 50, 8, 1320);
			attr_dev(article, "class", "svelte-8jfc9m");
			add_location(article, file, 48, 6, 1270);
			attr_dev(aside, "class", "svelte-8jfc9m");
			add_location(aside, file, 54, 6, 1405);
			attr_dev(div, "class", "impair svelte-8jfc9m");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div, "class", "content svelte-8jfc9m");
