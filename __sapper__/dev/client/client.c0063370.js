...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 43, 1, 546);
		},
		m: function mount(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 38, 0, 477);
			attr_dev(p, "class", "svelte-6jdhpp");
			add_location(p, file, 40, 0, 496);
...
const components = [
	{
		js: () => Promise.all([import('./index.a51681ee.js'), __inject_styles(["client-5088e28a.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7c906321.js'), __inject_styles(["client-5088e28a.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c4aca4d8.js'), __inject_styles(["client-5088e28a.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4d1ed8f0.js'), __inject_styles(["client-5088e28a.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.51de0be7.js'), __inject_styles(["client-5088e28a.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.97894b62.js'), __inject_styles(["client-5088e28a.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].cb259013.js'), __inject_styles(["client-5088e28a.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8e9e33a7.js'), __inject_styles(["client-5088e28a.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ff82d395.js'), __inject_styles(["client-5088e28a.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.feec242b.js'), __inject_styles(["client-5088e28a.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.312b88de.js'), __inject_styles(["client-5088e28a.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
