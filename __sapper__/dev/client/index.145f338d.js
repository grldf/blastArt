...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 999);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1149);
			...
			add_location(video, file, 41, 4, 1026);
			add_location(div, file, 39, 0, 989);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				description: "Le collectif Blast art vous amènes à voyager à travers de leurs vidéos. Leur travail très engagé  ",
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 940);
		},
		m: function mount(target, anchor) {
