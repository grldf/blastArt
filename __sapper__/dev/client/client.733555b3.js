...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-3klm51");
			add_location(h1, file, 30, 1, 423);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-3klm51");
			add_location(img, file, 31, 1, 437);
			attr_dev(div, "class", "container svelte-3klm51");
			add_location(div, file, 29, 0, 398);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.0c8ccb12.js'), __inject_styles(["client-d83d6374.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e1de868b.js'), __inject_styles(["client-d83d6374.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c35f4fae.js'), __inject_styles(["client-d83d6374.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c62fa8e9.js'), __inject_styles(["client-d83d6374.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.36458fe3.js'), __inject_styles(["client-d83d6374.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.580640ba.js'), __inject_styles(["client-d83d6374.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].86d26498.js'), __inject_styles(["client-d83d6374.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a8f21d76.js'), __inject_styles(["client-d83d6374.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f290472e.js'), __inject_styles(["client-d83d6374.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e69dae04.js'), __inject_styles(["client-d83d6374.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.eef9b708.js'), __inject_styles(["client-d83d6374.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
