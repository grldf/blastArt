...
const components = [
	{
		js: () => Promise.all([import('./index.47c57d4b.js'), __inject_styles(["client-51699124.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f61834f2.js'), __inject_styles(["client-51699124.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6d7f942c.js'), __inject_styles(["client-51699124.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.df7cd5e1.js'), __inject_styles(["client-51699124.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f09d243f.js'), __inject_styles(["client-51699124.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4139f860.js'), __inject_styles(["client-51699124.css","index-8bbba276.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].a2077297.js'), __inject_styles(["client-51699124.css","[slug]-9c4235b2.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f4b0a197.js'), __inject_styles(["client-51699124.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.116bf997.js'), __inject_styles(["client-51699124.css","index-8c1d5cad.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2c25a4d0.js'), __inject_styles(["client-51699124.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5d08d7b0.js'), __inject_styles(["client-51699124.css","index-a228bc7e.css"])]).then(function(x) { return x[0]; })
	}
];
