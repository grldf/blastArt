import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, m as claim_text, f as detach_dev, g as claim_space, h as attr_dev, j as add_location, w as toggle_class, k as insert_dev, l as append_dev, q as set_data_dev, n as noop, o as validate_each_argument, E as create_component, F as claim_component, G as mount_component, z as transition_in, A as transition_out, I as destroy_component, y as listen_dev, B as check_outros, u as destroy_each, C as run_all, J as group_outros } from './client.6e2f1404.js';
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "numbertext svelte-19r8e2a");
			...
			attr_dev(img, "class", "svelte-19r8e2a");
			add_location(img, file$1, 12, 2, 289);
			attr_dev(a, "href", /*slug*/ ctx[6]);
			attr_dev(a, "class", "link svelte-19r8e2a");
			add_location(a, file$1, 14, 7, 358);
			attr_dev(p, "class", "svelte-19r8e2a");
			add_location(p, file$1, 14, 4, 355);
			attr_dev(div1, "class", "infos svelte-19r8e2a");
			add_location(div1, file$1, 13, 2, 331);
			attr_dev(div2, "class", "mySlides svelte-19r8e2a");
