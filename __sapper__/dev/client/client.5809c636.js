...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-8iq4ru");
			add_location(h1, file, 30, 1, 424);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-8iq4ru");
			add_location(img, file, 31, 1, 438);
			attr_dev(div, "class", "container svelte-8iq4ru");
			add_location(div, file, 29, 0, 399);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.5100ab5f.js'), __inject_styles(["client-cc033fe7.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.408a029e.js'), __inject_styles(["client-cc033fe7.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0ec32620.js'), __inject_styles(["client-cc033fe7.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.42278c05.js'), __inject_styles(["client-cc033fe7.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fe068730.js'), __inject_styles(["client-cc033fe7.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.00057679.js'), __inject_styles(["client-cc033fe7.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].d5d7d7ac.js'), __inject_styles(["client-cc033fe7.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.31d6c475.js'), __inject_styles(["client-cc033fe7.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7079e2d9.js'), __inject_styles(["client-cc033fe7.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bddf5d52.js'), __inject_styles(["client-cc033fe7.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bd3efc50.js'), __inject_styles(["client-cc033fe7.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
