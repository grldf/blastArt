import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as attr_dev, k as add_location, l as toggle_class, m as insert_dev, n as append_dev, o as set_data_dev, p as noop, q as validate_each_argument, r as create_component, u as claim_component, w as mount_component, x as transition_in, y as transition_out, z as destroy_component, A as query_selector_all, B as listen_dev, C as check_outros, D as destroy_each, E as run_all, F as group_outros } from './client.5ba93e63.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 58, 0, 1028);
			attr_dev(a0, "href", "#arrowL");
			attr_dev(a0, "class", "prev svelte-1b73k3d");
			add_location(a0, file, 71, 1, 1401);
			attr_dev(a1, "href", "#arrowR");
			attr_dev(a1, "class", "next svelte-1b73k3d");
			add_location(a1, file, 72, 1, 1467);
			add_location(div1, file, 57, 0, 1022);
		},
		m: function mount(target, anchor) {
...
function preload({ query }) {
	...
	const results = client.query({ query: imageQuery });
