...
function create_fragment$1(ctx) {
	...
	let span;
	let t4;
	let t5_value = /*prixProduit*/ ctx[2] + sel + "";
	let t5;
	let t6;
	let t7;
	let select;
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$1, 28, 6, 621);
			option1.__value = "0";
			option1.value = option1.__value;
			add_location(option1, file$1, 29, 6, 671);
			option2.__value = "110";
			option2.value = option2.__value;
			add_location(option2, file$1, 30, 6, 709);
			option3.__value = "110";
			option3.value = option3.__value;
			add_location(option3, file$1, 31, 6, 748);
			option4.__value = "110";
			option4.value = option4.__value;
			add_location(option4, file$1, 32, 6, 788);
			option5.__value = "110";
			option5.value = option5.__value;
			add_location(option5, file$1, 33, 6, 832);
			attr_dev(select, "id", "select-support");
			add_location(select, file$1, 27, 4, 586);
			...
			add_location(img, file$1, 37, 2, 890);
			...
			add_location(div, file$1, 38, 2, 950);
		...
		p: function update(ctx, [dirty]) {
			...
			if ((!current || dirty & /*prixProduit*/ 4) && t5_value !== (t5_value = /*prixProduit*/ ctx[2] + sel + "")) set_data_dev(t5, t5_value);
