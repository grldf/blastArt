...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file, 34, 4, 701);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 36, 8, 838);
			...
			add_location(video, file, 35, 4, 728);
			add_location(div, file, 33, 0, 691);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 31, 0, 643);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
