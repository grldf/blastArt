...
const components = [
	{
		js: () => Promise.all([import('./index.39deb463.js'), __inject_styles(["client-c5e072b2.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3c463938.js'), __inject_styles(["client-c5e072b2.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.12db31e6.js'), __inject_styles(["client-c5e072b2.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ede53472.js'), __inject_styles(["client-c5e072b2.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.19312fe2.js'), __inject_styles(["client-c5e072b2.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.692a7130.js'), __inject_styles(["client-c5e072b2.css","index-5dafdbbd.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].2c55f0eb.js'), __inject_styles(["client-c5e072b2.css","[slug]-a48d5e49.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.55acbb73.js'), __inject_styles(["client-c5e072b2.css","index-f29200bc.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4ea986bf.js'), __inject_styles(["client-c5e072b2.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e78f8d80.js'), __inject_styles(["client-c5e072b2.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6fca86ab.js'), __inject_styles(["client-c5e072b2.css","index-e437e08e.css"])]).then(function(x) { return x[0]; })
	}
];
