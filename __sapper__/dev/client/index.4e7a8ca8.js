...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div, "class", "btns svelte-gpbtki");
			add_location(div, file$1, 30, 2, 651);
			attr_dev(article, "class", "svelte-gpbtki");
