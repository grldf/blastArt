...
const components = [
	{
		js: () => Promise.all([import('./index.ca9a1422.js'), __inject_styles(["client-ba589e00.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.74244d1b.js'), __inject_styles(["client-ba589e00.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bf205298.js'), __inject_styles(["client-ba589e00.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0a702244.js'), __inject_styles(["client-ba589e00.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.dbb696cd.js'), __inject_styles(["client-ba589e00.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.82c8e278.js'), __inject_styles(["client-ba589e00.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].a71e0999.js'), __inject_styles(["client-ba589e00.css","[slug]-af9b0efe.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6f1df0df.js'), __inject_styles(["client-ba589e00.css","index-f53b6465.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.258a7c89.js'), __inject_styles(["client-ba589e00.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.30ae2729.js'), __inject_styles(["client-ba589e00.css","index-ded347c3.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5e12421b.js'), __inject_styles(["client-ba589e00.css","index-4525c145.css"])]).then(function(x) { return x[0]; })
	}
];
