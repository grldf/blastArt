...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t8 = text("--Please choose an option--");
		...
		l: function claim(nodes) {
			...
			t8 = claim_text(option0_nodes, "--Please choose an option--");
		...
		h: function hydrate() {
			...
			add_location(option2, file$1, 30, 6, 710);
			option3.__value = "hamster";
			option3.value = option3.__value;
			add_location(option3, file$1, 31, 6, 749);
			option4.__value = "parrot";
			option4.value = option4.__value;
			add_location(option4, file$1, 32, 6, 796);
			option5.__value = "spider";
			option5.value = option5.__value;
			add_location(option5, file$1, 33, 6, 841);
			option6.__value = "goldfish";
			option6.value = option6.__value;
			add_location(option6, file$1, 34, 6, 886);
			...
			add_location(img, file$1, 38, 2, 956);
			...
			add_location(button, file$1, 40, 2, 1037);
			attr_dev(div, "class", "btns svelte-1ernrbq");
			add_location(div, file$1, 39, 2, 1016);
