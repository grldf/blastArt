...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$1, 28, 6, 607);
			option1.__value = "0";
			option1.value = option1.__value;
			add_location(option1, file$1, 29, 6, 657);
			option2.__value = "110";
			option2.value = option2.__value;
			add_location(option2, file$1, 30, 6, 695);
			option3.__value = "110";
			option3.value = option3.__value;
			add_location(option3, file$1, 31, 6, 734);
			option4.__value = "110";
			option4.value = option4.__value;
			add_location(option4, file$1, 32, 6, 774);
			option5.__value = "110";
			option5.value = option5.__value;
			add_location(option5, file$1, 33, 6, 818);
			...
			add_location(img, file$1, 37, 2, 876);
			...
			add_location(button, file$1, 39, 2, 957);
			attr_dev(div, "class", "btns svelte-1ernrbq");
			add_location(div, file$1, 38, 2, 936);
