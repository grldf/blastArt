...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$1, 93, 4, 2162);
			attr_dev(button0, "class", "prev svelte-1amwhzi");
			add_location(button0, file$1, 107, 6, 2581);
			attr_dev(button1, "class", "next svelte-1amwhzi");
			add_location(button1, file$1, 108, 6, 2647);
			...
			add_location(circle0, file$1, 119, 10, 2998);
			...
			add_location(path0, file$1, 133, 12, 3374);
			...
			add_location(path1, file$1, 140, 12, 3802);
			...
			add_location(path2, file$1, 147, 12, 4273);
			...
			add_location(svg0, file$1, 110, 6, 2714);
			...
			add_location(circle1, file$1, 173, 10, 5519);
			...
			add_location(path4, file$1, 182, 10, 5762);
			...
			add_location(path5, file$1, 189, 10, 6018);
			...
			add_location(path6, file$1, 196, 10, 6278);
			...
			add_location(svg1, file$1, 164, 6, 5246);
			attr_dev(div2, "class", "galery svelte-1amwhzi");
			add_location(div2, file$1, 95, 4, 2189);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, nav);
		...
		p: function update(ctx, dirty) {
			...
			if ((!current || dirty & /*post*/ 1) && raw_value !== (raw_value = t(/*info*/ ctx[8].description) + "")) div0.innerHTML = raw_value;			if ((!current || dirty & /*post*/ 1) && t4_value !== (t4_value = /*info*/ ctx[8].titre + "")) set_data_dev(t4, t4_value);
