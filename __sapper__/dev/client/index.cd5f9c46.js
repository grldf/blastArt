...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 41, 4, 982);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 43, 6, 1132);
			...
			add_location(video, file, 42, 4, 1009);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 37, 0, 923);
		},
		m: function mount(target, anchor) {
