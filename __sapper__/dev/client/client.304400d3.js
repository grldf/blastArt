...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 27, 1, 384);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-4cxpt4");
			add_location(img, file, 28, 1, 398);
			attr_dev(div, "class", "container svelte-4cxpt4");
...
const components = [
	{
		js: () => Promise.all([import('./index.28005881.js'), __inject_styles(["client-0d6a6153.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9fd4d87b.js'), __inject_styles(["client-0d6a6153.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.589cc75e.js'), __inject_styles(["client-0d6a6153.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.68c7ddf7.js'), __inject_styles(["client-0d6a6153.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bfe677bb.js'), __inject_styles(["client-0d6a6153.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.dbf62e0f.js'), __inject_styles(["client-0d6a6153.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].0c066ee8.js'), __inject_styles(["client-0d6a6153.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.aeb3432d.js'), __inject_styles(["client-0d6a6153.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.52fdbfee.js'), __inject_styles(["client-0d6a6153.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.07f04db5.js'), __inject_styles(["client-0d6a6153.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f38750f3.js'), __inject_styles(["client-0d6a6153.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
