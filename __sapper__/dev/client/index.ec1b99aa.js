...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 1012);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1162);
			...
			add_location(video, file, 41, 4, 1039);
			add_location(div, file, 39, 0, 1002);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 953);
		},
		m: function mount(target, anchor) {
