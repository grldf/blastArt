...
const components = [
	{
		js: () => Promise.all([import('./index.32e138f3.js'), __inject_styles(["client-47bb6c42.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a7d99d2e.js'), __inject_styles(["client-47bb6c42.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.801cc4d0.js'), __inject_styles(["client-47bb6c42.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.606ce5de.js'), __inject_styles(["client-47bb6c42.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f85c56e0.js'), __inject_styles(["client-47bb6c42.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7d46db59.js'), __inject_styles(["client-47bb6c42.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].037086c3.js'), __inject_styles(["client-47bb6c42.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.753cca83.js'), __inject_styles(["client-47bb6c42.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9fbd0711.js'), __inject_styles(["client-47bb6c42.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.91355b7d.js'), __inject_styles(["client-47bb6c42.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6aca61f7.js'), __inject_styles(["client-47bb6c42.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
