...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 974);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1124);
			...
			add_location(video, file, 41, 4, 1001);
			add_location(div, file, 39, 0, 964);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				description: "Le collectif Blast art vous amènes à voyager à travers de leurs vidéos.  ",
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 915);
		},
		m: function mount(target, anchor) {
