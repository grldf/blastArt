...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 922);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1072);
			...
			add_location(video, file, 41, 4, 949);
			add_location(div, file, 39, 0, 912);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				description: "Le collectif vous am ",
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 863);
		},
		m: function mount(target, anchor) {
