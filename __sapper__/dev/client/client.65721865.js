...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a0, "class", "svelte-gyp81g");
			...
			attr_dev(a1, "class", "svelte-gyp81g");
			...
			attr_dev(a2, "class", "svelte-gyp81g");
			add_location(a2, file$7, 15, 2, 291);
			attr_dev(button, "class", "snipcart-customer-signin svelte-gyp81g");
			add_location(button, file$7, 20, 2, 421);
			attr_dev(footer, "class", "svelte-gyp81g");
...
const components = [
	{
		js: () => Promise.all([import('./index.9be279dd.js'), __inject_styles(["client-7fb72bef.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.93a7f3fb.js'), __inject_styles(["client-7fb72bef.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4bf9496f.js'), __inject_styles(["client-7fb72bef.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.65f3da9f.js'), __inject_styles(["client-7fb72bef.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.877bb6ab.js'), __inject_styles(["client-7fb72bef.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.50854f2f.js'), __inject_styles(["client-7fb72bef.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].1832f593.js'), __inject_styles(["client-7fb72bef.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b44d8b33.js'), __inject_styles(["client-7fb72bef.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.09f19b57.js'), __inject_styles(["client-7fb72bef.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.96dc72fa.js'), __inject_styles(["client-7fb72bef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.960f53a8.js'), __inject_styles(["client-7fb72bef.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
