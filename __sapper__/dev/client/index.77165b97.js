...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-rs6bee");
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-rs6bee");
			add_location(h2, file, 49, 8, 1288);
			attr_dev(p, "class", "svelte-rs6bee");
			add_location(p, file, 50, 8, 1320);
			attr_dev(article, "class", "svelte-rs6bee");
			add_location(article, file, 48, 6, 1270);
			attr_dev(aside, "class", "svelte-rs6bee");
			add_location(aside, file, 54, 6, 1405);
			attr_dev(div, "class", "impair svelte-rs6bee");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div, "class", "content svelte-rs6bee");
