...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$1, 29, 6, 667);
			option1.__value = "0";
			option1.value = option1.__value;
			add_location(option1, file$1, 30, 6, 717);
			option2.__value = "110";
			option2.value = option2.__value;
			add_location(option2, file$1, 31, 6, 755);
			option3.__value = "110";
			option3.value = option3.__value;
			add_location(option3, file$1, 32, 6, 794);
			option4.__value = "110";
			option4.value = option4.__value;
			add_location(option4, file$1, 33, 6, 834);
			option5.__value = "110";
			option5.value = option5.__value;
			add_location(option5, file$1, 34, 6, 878);
			attr_dev(select, "id", "select-support");
			if (/*selected*/ ctx[13] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[16].call(select));
			add_location(select, file$1, 28, 4, 610);
