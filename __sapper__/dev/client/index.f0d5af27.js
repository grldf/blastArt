...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 55, 2, 1861);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file, 59, 8, 1983);
			attr_dev(p, "class", "svelte-12psx4l");
			add_location(p, file, 60, 8, 2011);
			attr_dev(article, "class", "svelte-12psx4l");
			add_location(article, file, 58, 6, 1965);
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				...
				title: "Portrait des différents membres du collefif Blast ,",
				openGraph: {
					type: "article",
