...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1dgtxb9");
			add_location(img, file, 27, 1, 400);
			attr_dev(div, "class", "container svelte-1dgtxb9");
			add_location(div, file, 26, 0, 375);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.ef09e14c.js'), __inject_styles(["client-86c9a561.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1fe004e9.js'), __inject_styles(["client-86c9a561.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5f1f3366.js'), __inject_styles(["client-86c9a561.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4bc2e31f.js'), __inject_styles(["client-86c9a561.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e2d66fc7.js'), __inject_styles(["client-86c9a561.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c5983ec3.js'), __inject_styles(["client-86c9a561.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].b5f3df67.js'), __inject_styles(["client-86c9a561.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.46f2336e.js'), __inject_styles(["client-86c9a561.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d0da41b0.js'), __inject_styles(["client-86c9a561.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.269c3756.js'), __inject_styles(["client-86c9a561.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8f7e1dee.js'), __inject_styles(["client-86c9a561.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
