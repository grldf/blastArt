...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-paauh2");
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h2, "class", "svelte-paauh2");
			add_location(h2, file, 49, 8, 1301);
			attr_dev(p, "class", "svelte-paauh2");
			add_location(p, file, 50, 8, 1333);
			attr_dev(article, "class", "svelte-paauh2");
			add_location(article, file, 48, 6, 1283);
			attr_dev(div, "class", "impair svelte-paauh2");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div, "class", "content svelte-paauh2");
