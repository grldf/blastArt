...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t8 = claim_text(option0_nodes, "--Choi--");
		...
		h: function hydrate() {
			...
			add_location(option1, file$1, 29, 6, 652);
			option2.__value = "cat";
			option2.value = option2.__value;
			add_location(option2, file$1, 30, 6, 691);
			option3.__value = "hamster";
			option3.value = option3.__value;
			add_location(option3, file$1, 31, 6, 730);
			option4.__value = "parrot";
			option4.value = option4.__value;
			add_location(option4, file$1, 32, 6, 777);
