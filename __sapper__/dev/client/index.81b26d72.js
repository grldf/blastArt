import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as attr_dev, k as add_location, m as insert_dev, n as append_dev, p as noop } from './client.5d50ec2a.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-tlk1qv");
			...
			attr_dev(img, "class", "svelte-tlk1qv");
			add_location(img, file, 37, 4, 857);
			attr_dev(label0, "for", "lastname");
			attr_dev(label0, "class", "svelte-tlk1qv");
			...
			attr_dev(input0, "class", "svelte-tlk1qv");
			add_location(input0, file, 44, 6, 1049);
			attr_dev(label1, "for", "name");
			attr_dev(label1, "class", "svelte-tlk1qv");
