...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 41, 4, 1003);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 43, 6, 1153);
			...
			add_location(video, file, 42, 4, 1030);
			add_location(div, file, 40, 0, 993);
		},
...
function create_fragment(ctx) {
	...
	svelteseo = new SvelteSeo({
			props: {
				...
				title: "Vidéos présentant le travail du collect"
			},
			$$inline: true
		});
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 37, 0, 944);
		},
		m: function mount(target, anchor) {
