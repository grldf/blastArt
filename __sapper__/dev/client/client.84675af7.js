...
function create_default_slot$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(button, "class", "svelte-rvzhk7");
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(main, "class", "svelte-rvzhk7");
			add_location(main, file$1, 11, 0, 332);
			attr_dev(br, "class", "last-br svelte-rvzhk7");
...
const components = [
	{
		js: () => Promise.all([import('./index.604f3dfd.js'), __inject_styles(["client-fbec97be.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8ffe9e5c.js'), __inject_styles(["client-fbec97be.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.be47725d.js'), __inject_styles(["client-fbec97be.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ee34f9c9.js'), __inject_styles(["client-fbec97be.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f4000a97.js'), __inject_styles(["client-fbec97be.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5e042aef.js'), __inject_styles(["client-fbec97be.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].81c55c19.js'), __inject_styles(["client-fbec97be.css","[slug]-af9b0efe.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d741b0fb.js'), __inject_styles(["client-fbec97be.css","index-f53b6465.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a9eee398.js'), __inject_styles(["client-fbec97be.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.56fd0fd1.js'), __inject_styles(["client-fbec97be.css","index-ded347c3.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4a2137a1.js'), __inject_styles(["client-fbec97be.css","index-4525c145.css"])]).then(function(x) { return x[0]; })
	}
];
