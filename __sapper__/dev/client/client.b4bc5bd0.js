...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(metadata, file$8, 146, 10, 6826);
			...
			add_location(path0, file$8, 154, 12, 7104);
			...
			add_location(path1, file$8, 208, 12, 11237);
			...
			add_location(svg, file$8, 138, 9, 6575);
			attr_dev(button, "class", "snipcart-checkout svelte-8ktzfm");
			add_location(button, file$8, 137, 6, 6532);
			attr_dev(span0, "class", "snipcart-items-count");
			add_location(span0, file$8, 222, 19, 11718);
			add_location(br, file$8, 222, 56, 11755);
			attr_dev(span1, "class", "snipcart-total-price");
			add_location(span1, file$8, 223, 15, 11777);
			attr_dev(p, "class", "info-prix svelte-8ktzfm");
			add_location(p, file$8, 221, 6, 11677);
...
function create_default_slot$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a7, file$8, 263, 4, 12911);
			...
			add_location(a8, file$8, 268, 4, 13041);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.49ed2d60.js'), __inject_styles(["client-12cd6d63.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d1271fb9.js'), __inject_styles(["client-12cd6d63.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.46d9868b.js'), __inject_styles(["client-12cd6d63.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.63ce9fc5.js'), __inject_styles(["client-12cd6d63.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.26bf551e.js'), __inject_styles(["client-12cd6d63.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d52cdd6d.js'), __inject_styles(["client-12cd6d63.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].cabc0c69.js'), __inject_styles(["client-12cd6d63.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fb271d61.js'), __inject_styles(["client-12cd6d63.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3c30e062.js'), __inject_styles(["client-12cd6d63.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.53c75e04.js'), __inject_styles(["client-12cd6d63.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9fb31d0b.js'), __inject_styles(["client-12cd6d63.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
