...
const components = [
	{
		js: () => Promise.all([import('./index.e98625bb.js'), __inject_styles(["client-c5e072b2.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7fde15f8.js'), __inject_styles(["client-c5e072b2.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.04426063.js'), __inject_styles(["client-c5e072b2.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e69dd73f.js'), __inject_styles(["client-c5e072b2.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.70192cb6.js'), __inject_styles(["client-c5e072b2.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.355cb84f.js'), __inject_styles(["client-c5e072b2.css","index-5dafdbbd.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].c62ce4a7.js'), __inject_styles(["client-c5e072b2.css","[slug]-a48d5e49.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7d2ff16b.js'), __inject_styles(["client-c5e072b2.css","index-48f95a55.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.72aaafd0.js'), __inject_styles(["client-c5e072b2.css","index-9cf00358.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.cfe27385.js'), __inject_styles(["client-c5e072b2.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1b0bba00.js'), __inject_styles(["client-c5e072b2.css","index-e437e08e.css"])]).then(function(x) { return x[0]; })
	}
];
