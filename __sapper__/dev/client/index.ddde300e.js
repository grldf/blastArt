...
function create_fragment$1(ctx) {
	...
	let span;
	let t4;
	let t5_value = /*prixProduit*/ ctx[2] + select - supprt + "";
	let t5;
	let t6;
	let t7;
	let select_1;
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$1, 28, 6, 631);
			option1.__value = "0";
			option1.value = option1.__value;
			add_location(option1, file$1, 29, 6, 681);
			option2.__value = "110";
			option2.value = option2.__value;
			add_location(option2, file$1, 30, 6, 719);
			option3.__value = "110";
			option3.value = option3.__value;
			add_location(option3, file$1, 31, 6, 758);
			option4.__value = "110";
			option4.value = option4.__value;
			add_location(option4, file$1, 32, 6, 798);
			option5.__value = "110";
			option5.value = option5.__value;
			add_location(option5, file$1, 33, 6, 842);
			attr_dev(select_1, "id", "select-support");
			add_location(select_1, file$1, 27, 4, 596);
			...
			add_location(img, file$1, 37, 2, 900);
			...
			add_location(button, file$1, 39, 2, 981);
			attr_dev(div, "class", "btns svelte-1ernrbq");
			add_location(div, file$1, 38, 2, 960);
		...
		p: function update(ctx, [dirty]) {
			...
			if ((!current || dirty & /*prixProduit*/ 4) && t5_value !== (t5_value = /*prixProduit*/ ctx[2] + select - supprt + "")) set_data_dev(t5, t5_value);
