...
const components = [
	{
		js: () => Promise.all([import('./index.e7017726.js'), __inject_styles(["client-ba589e00.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b6ef6eab.js'), __inject_styles(["client-ba589e00.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.40e52e9b.js'), __inject_styles(["client-ba589e00.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.afbde56f.js'), __inject_styles(["client-ba589e00.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f58ac1a6.js'), __inject_styles(["client-ba589e00.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1ed7d689.js'), __inject_styles(["client-ba589e00.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].c779956f.js'), __inject_styles(["client-ba589e00.css","[slug]-af9b0efe.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.545badc8.js'), __inject_styles(["client-ba589e00.css","index-f53b6465.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c7e013e4.js'), __inject_styles(["client-ba589e00.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0ee31c58.js'), __inject_styles(["client-ba589e00.css","index-4ab86646.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d8a789a7.js'), __inject_styles(["client-ba589e00.css","index-4525c145.css"])]).then(function(x) { return x[0]; })
	}
];
