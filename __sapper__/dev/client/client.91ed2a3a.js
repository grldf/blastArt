...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-1gpqj44");
			add_location(img, file, 25, 1, 370);
			attr_dev(div, "class", "container svelte-1gpqj44");
			add_location(div, file, 24, 0, 345);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.9cafee55.js'), __inject_styles(["client-40024a4c.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3b7521da.js'), __inject_styles(["client-40024a4c.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4be12f07.js'), __inject_styles(["client-40024a4c.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.17cf97a3.js'), __inject_styles(["client-40024a4c.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3a68ff9d.js'), __inject_styles(["client-40024a4c.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bf1d3687.js'), __inject_styles(["client-40024a4c.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].cf44f620.js'), __inject_styles(["client-40024a4c.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.44149f12.js'), __inject_styles(["client-40024a4c.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7d05769d.js'), __inject_styles(["client-40024a4c.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d822e50d.js'), __inject_styles(["client-40024a4c.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7ed847a3.js'), __inject_styles(["client-40024a4c.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
