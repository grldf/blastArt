...
const components = [
	{
		js: () => Promise.all([import('./index.8b4bba25.js'), __inject_styles(["client-e49779fb.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5f52b698.js'), __inject_styles(["client-e49779fb.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c2b66864.js'), __inject_styles(["client-e49779fb.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2ce1e086.js'), __inject_styles(["client-e49779fb.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0ddcfda6.js'), __inject_styles(["client-e49779fb.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b8f0abde.js'), __inject_styles(["client-e49779fb.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].dc4c71be.js'), __inject_styles(["client-e49779fb.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.06343082.js'), __inject_styles(["client-e49779fb.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.21ca9826.js'), __inject_styles(["client-e49779fb.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.a8b24a6d.js'), __inject_styles(["client-e49779fb.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.edcb552c.js'), __inject_styles(["client-e49779fb.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
