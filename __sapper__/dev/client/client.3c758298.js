...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1o70msn");
			add_location(h1, file, 30, 1, 414);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-1o70msn");
			add_location(img, file, 31, 1, 428);
			attr_dev(div, "class", "container svelte-1o70msn");
			add_location(div, file, 29, 0, 389);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.0c7dbbd0.js'), __inject_styles(["client-77f32c9a.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6cd6e6ec.js'), __inject_styles(["client-77f32c9a.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.20697ee6.js'), __inject_styles(["client-77f32c9a.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3464bed3.js'), __inject_styles(["client-77f32c9a.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ea84a091.js'), __inject_styles(["client-77f32c9a.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.67af2155.js'), __inject_styles(["client-77f32c9a.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].4f227395.js'), __inject_styles(["client-77f32c9a.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7e01d6d0.js'), __inject_styles(["client-77f32c9a.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.ec355155.js'), __inject_styles(["client-77f32c9a.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.63fd17b8.js'), __inject_styles(["client-77f32c9a.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.eaa024ff.js'), __inject_styles(["client-77f32c9a.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
