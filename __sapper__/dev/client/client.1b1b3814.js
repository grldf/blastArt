...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file, 44, 1, 580);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(44:0) {#if dev && error.stack}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 38, 1, 446);
			attr_dev(h1, "class", "svelte-1plf7i4");
			add_location(h1, file, 39, 0, 511);
			attr_dev(p, "class", "svelte-1plf7i4");
			add_location(p, file, 41, 0, 530);
			attr_dev(div, "class", "container svelte-1plf7i4");
			add_location(div, file, 37, 0, 421);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.06a30139.js'), __inject_styles(["client-313560b8.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fc6dc60f.js'), __inject_styles(["client-313560b8.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.db570793.js'), __inject_styles(["client-313560b8.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.618bafef.js'), __inject_styles(["client-313560b8.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.35afeae5.js'), __inject_styles(["client-313560b8.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e488cc43.js'), __inject_styles(["client-313560b8.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].16028a46.js'), __inject_styles(["client-313560b8.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f18be7e3.js'), __inject_styles(["client-313560b8.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e7a0315e.js'), __inject_styles(["client-313560b8.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d91cd9d1.js'), __inject_styles(["client-313560b8.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.55275ba9.js'), __inject_styles(["client-313560b8.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
