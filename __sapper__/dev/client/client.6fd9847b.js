...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-d0npiq");
			add_location(img, file, 26, 1, 371);
			attr_dev(div, "class", "container svelte-d0npiq");
			add_location(div, file, 25, 0, 346);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.8e95f37f.js'), __inject_styles(["client-52a1fb58.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9bcf8de7.js'), __inject_styles(["client-52a1fb58.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d2e71bda.js'), __inject_styles(["client-52a1fb58.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.164b29c4.js'), __inject_styles(["client-52a1fb58.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b1bd191e.js'), __inject_styles(["client-52a1fb58.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0c32c70e.js'), __inject_styles(["client-52a1fb58.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].ccdc308d.js'), __inject_styles(["client-52a1fb58.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.e6c09f4f.js'), __inject_styles(["client-52a1fb58.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.aa18c9e1.js'), __inject_styles(["client-52a1fb58.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9843cfce.js'), __inject_styles(["client-52a1fb58.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2677485f.js'), __inject_styles(["client-52a1fb58.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
