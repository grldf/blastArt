...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1k49hr2");
			add_location(h1, file, 31, 1, 442);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-1k49hr2");
			add_location(img, file, 32, 1, 456);
			attr_dev(div, "class", "container svelte-1k49hr2");
			add_location(div, file, 30, 0, 417);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.2b86d1cc.js'), __inject_styles(["client-b94d0eeb.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4ba3fab5.js'), __inject_styles(["client-b94d0eeb.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.fa1776f8.js'), __inject_styles(["client-b94d0eeb.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8db8713d.js'), __inject_styles(["client-b94d0eeb.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.69128d3f.js'), __inject_styles(["client-b94d0eeb.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.36bc7721.js'), __inject_styles(["client-b94d0eeb.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].6bb8b1ba.js'), __inject_styles(["client-b94d0eeb.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7d3e0d79.js'), __inject_styles(["client-b94d0eeb.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.24c5877c.js'), __inject_styles(["client-b94d0eeb.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.128e6335.js'), __inject_styles(["client-b94d0eeb.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b7c00b1e.js'), __inject_styles(["client-b94d0eeb.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
