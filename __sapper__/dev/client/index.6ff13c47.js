...
// (51:2) {#if data-item-custom1-name === Papier }
function create_if_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(51:2) {#if data-item-custom1-name === Papier }",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = data - item - /*custom1*/ ctx[7] - name === Papier && create_if_block_1(ctx);
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (data - item - /*custom1*/ ctx[7] - name === Papier) {
				if (if_block0) ; else {
