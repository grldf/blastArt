...
const components = [
	{
		js: () => Promise.all([import('./index.8c6d523e.js'), __inject_styles(["client-c5e072b2.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8eb906c7.js'), __inject_styles(["client-c5e072b2.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.dc7753f7.js'), __inject_styles(["client-c5e072b2.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0654ecb1.js'), __inject_styles(["client-c5e072b2.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b3d23515.js'), __inject_styles(["client-c5e072b2.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2043b53e.js'), __inject_styles(["client-c5e072b2.css","index-5dafdbbd.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].51eeebae.js'), __inject_styles(["client-c5e072b2.css","[slug]-a48d5e49.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.eceb0a4c.js'), __inject_styles(["client-c5e072b2.css","index-85cd60e3.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f4a58905.js'), __inject_styles(["client-c5e072b2.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f8a0671d.js'), __inject_styles(["client-c5e072b2.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.44af3c5e.js'), __inject_styles(["client-c5e072b2.css","index-e437e08e.css"])]).then(function(x) { return x[0]; })
	}
];
