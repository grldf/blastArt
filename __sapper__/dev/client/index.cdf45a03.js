...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 40, 4, 901);
			attr_dev(track, "kind", "captions");
			add_location(track, file, 42, 6, 1051);
			...
			add_location(video, file, 41, 4, 928);
			add_location(div, file, 39, 0, 891);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 36, 0, 842);
		},
		m: function mount(target, anchor) {
