...
const components = [
	{
		js: () => Promise.all([import('./index.160a9231.js'), __inject_styles(["client-f7115c0d.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c81b0afa.js'), __inject_styles(["client-f7115c0d.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.4bcba2fb.js'), __inject_styles(["client-f7115c0d.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5e537eae.js'), __inject_styles(["client-f7115c0d.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d97930ca.js'), __inject_styles(["client-f7115c0d.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.93876bd4.js'), __inject_styles(["client-f7115c0d.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].c19c7f3e.js'), __inject_styles(["client-f7115c0d.css","[slug]-af9b0efe.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.28fdc9e4.js'), __inject_styles(["client-f7115c0d.css","index-f53b6465.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b6a299af.js'), __inject_styles(["client-f7115c0d.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.bc34884b.js'), __inject_styles(["client-f7115c0d.css","index-3d750760.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c610f0ae.js'), __inject_styles(["client-f7115c0d.css","index-4525c145.css"])]).then(function(x) { return x[0]; })
	}
];
