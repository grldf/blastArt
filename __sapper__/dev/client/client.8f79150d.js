...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(metadata, file$8, 148, 10, 6904);
			...
			add_location(path0, file$8, 156, 12, 7182);
			...
			add_location(path1, file$8, 210, 12, 11315);
			...
			add_location(svg, file$8, 140, 9, 6653);
			attr_dev(button, "class", "snipcart-checkout svelte-8ktzfm");
			add_location(button, file$8, 139, 6, 6610);
			...
			add_location(header, file$8, 138, 4, 6595);
			attr_dev(div, "class", "burger svelte-8ktzfm");
			add_location(div, file$8, 137, 2, 6570);
		},
		m: function mount(target, anchor) {
...
function create_if_block$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(span0, "class", "snipcart-items-count");
			add_location(span0, file$8, 131, 19, 6432);
			add_location(br, file$8, 131, 56, 6469);
			attr_dev(span1, "class", "snipcart-total-price");
			add_location(span1, file$8, 132, 15, 6491);
			attr_dev(p, "class", "info-prix svelte-8ktzfm");
...
const components = [
	{
		js: () => Promise.all([import('./index.746d7475.js'), __inject_styles(["client-c8a0415d.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.3eae30a4.js'), __inject_styles(["client-c8a0415d.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b82a134a.js'), __inject_styles(["client-c8a0415d.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d6e6209c.js'), __inject_styles(["client-c8a0415d.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.b821971d.js'), __inject_styles(["client-c8a0415d.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.1b0747d5.js'), __inject_styles(["client-c8a0415d.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].e079647a.js'), __inject_styles(["client-c8a0415d.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5eef7cb8.js'), __inject_styles(["client-c8a0415d.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.de31e780.js'), __inject_styles(["client-c8a0415d.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.08494a3c.js'), __inject_styles(["client-c8a0415d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.30cc3d63.js'), __inject_styles(["client-c8a0415d.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
