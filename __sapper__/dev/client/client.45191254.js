...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button0, file$8, 138, 6, 6539);
			add_location(metadata, file$8, 148, 10, 6900);
			...
			add_location(path0, file$8, 156, 12, 7178);
			...
			add_location(path1, file$8, 210, 12, 11311);
			...
			add_location(svg, file$8, 140, 9, 6649);
			attr_dev(button1, "class", "snipcart-checkout svelte-8ktzfm");
			add_location(button1, file$8, 139, 6, 6606);
...
const components = [
	{
		js: () => Promise.all([import('./index.f2e6b9b0.js'), __inject_styles(["client-c8a0415d.css","index-6a2bc968.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.65fba44f.js'), __inject_styles(["client-c8a0415d.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.cffc355f.js'), __inject_styles(["client-c8a0415d.css","index-ebbaaf4b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6754d75b.js'), __inject_styles(["client-c8a0415d.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.c3f49667.js'), __inject_styles(["client-c8a0415d.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.6d1e2401.js'), __inject_styles(["client-c8a0415d.css","index-93e0e21b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].4cc53f1b.js'), __inject_styles(["client-c8a0415d.css","[slug]-7f36219f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d19ab6e0.js'), __inject_styles(["client-c8a0415d.css","index-96f127f8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.9961eb41.js'), __inject_styles(["client-c8a0415d.css","index-435808ef.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.20566fd7.js'), __inject_styles(["client-c8a0415d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7a0c2cc7.js'), __inject_styles(["client-c8a0415d.css","index-5e4c9030.css"])]).then(function(x) { return x[0]; })
	}
];
