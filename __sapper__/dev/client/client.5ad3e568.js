...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-24b6rn");
			add_location(h1, file, 27, 1, 388);
			if (img.src !== (img_src_value = "/pirate.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "Cette page n'existe pas...désolé");
			attr_dev(img, "class", "svelte-24b6rn");
			add_location(img, file, 28, 1, 402);
			attr_dev(div, "class", "container svelte-24b6rn");
			add_location(div, file, 26, 0, 363);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, div, anchor);
...
const components = [
	{
		js: () => Promise.all([import('./index.bfb6dac1.js'), __inject_styles(["client-83735c1a.css","index-bd5a4262.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.68aacfae.js'), __inject_styles(["client-83735c1a.css","index-9d07180b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.64efd2b8.js'), __inject_styles(["client-83735c1a.css","index-6357a7c9.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.7d69ec9f.js'), __inject_styles(["client-83735c1a.css","index-f9423815.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f09bf2a2.js'), __inject_styles(["client-83735c1a.css","index-f272817a.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.339d3dc2.js'), __inject_styles(["client-83735c1a.css","index-6efda523.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[slug].30878537.js'), __inject_styles(["client-83735c1a.css","[slug]-99370e8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.d6d9f46b.js'), __inject_styles(["client-83735c1a.css","index-b834714c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.af66171b.js'), __inject_styles(["client-83735c1a.css","index-fbe8f2aa.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.009a8e75.js'), __inject_styles(["client-83735c1a.css","index-42b19cee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.8838c1ce.js'), __inject_styles(["client-83735c1a.css","index-f67c0fd0.css"])]).then(function(x) { return x[0]; })
	}
];
