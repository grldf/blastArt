import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, a as space, t as text, c as claim_element, g as claim_space, b as children, m as claim_text, f as detach_dev, h as attr_dev, j as add_location, o as set_style, k as insert_dev, l as append_dev, n as noop } from './client.3595dae9.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t17 = space();
			p0 = element("p");
			t18 = text("Veuillez choisir comment vous souhaitez avoir des nouvelles de blast:");
			t19 = space();
			...
			t21 = space();
			p1 = element("p");
			t22 = text("Vous pouvez vous désabonner à tout moment en cliquant sur le lien dans le bas de page de nos e-mails. Pour obtenir plus d'informations sur nos pratiques de confidentialité, rendez-vous sur notre site Web.");
			t23 = space();
			div5 = element("div");
			p2 = element("p");
			t24 = text("We use Mailchimp as our marketing platform. By clicking below to subscribe, you acknowledge that your information will be transferred to Mailchimp for processing. ");
			a = element("a");
		...
		l: function claim(nodes) {
			link = claim_element(nodes, "LINK", { href: true, rel: true, type: true });
			...
			t1 = claim_text(h2_nodes, "Subscribe");
			...
			label3 = claim_element(div4_nodes, "LABEL", { class: true });
			var label3_nodes = children(label3);
			t16 = claim_text(label3_nodes, "Autorisations de marketing");
			label3_nodes.forEach(detach_dev);
			t17 = claim_space(div4_nodes);
			p0 = claim_element(div4_nodes, "P", {});
			var p0_nodes = children(p0);
			t18 = claim_text(p0_nodes, "Veuillez choisir comment vous souhaitez avoir des nouvelles de blast:");
			...
			label4 = claim_element(fieldset_nodes, "LABEL", { class: true, for: true });
			var label4_nodes = children(label4);

			input3 = claim_element(label4_nodes, "INPUT", {
				type: true,
				id: true,
				name: true,
				value: true,
			...
			span2 = claim_element(label4_nodes, "SPAN", {});
			...
			t22 = claim_text(p1_nodes, "Vous pouvez vous désabonner à tout moment en cliquant sur le lien dans le bas de page de nos e-mails. Pour obtenir plus d'informations sur nos pratiques de confidentialité, rendez-vous sur notre site Web.");
			...
			t24 = claim_text(p2_nodes, "We use Mailchimp as our marketing platform. By clicking below to subscribe, you acknowledge that your information will be transferred to Mailchimp for processing. ");
		...
		h: function hydrate() {
			...
			add_location(link, file, 1, 0, 37);
			add_location(h2, file, 12, 1, 758);
			attr_dev(span0, "class", "asterisk");
			add_location(span0, file, 13, 32, 809);
			attr_dev(div0, "class", "indicates-required");
			add_location(div0, file, 13, 0, 777);
			attr_dev(span1, "class", "asterisk");
			add_location(span1, file, 15, 39, 934);
			attr_dev(label0, "for", "mce-EMAIL");
			add_location(label0, file, 15, 1, 896);
			attr_dev(input0, "type", "email");
			input0.value = "";
			attr_dev(input0, "name", "EMAIL");
			attr_dev(input0, "class", "required email");
			attr_dev(input0, "id", "mce-EMAIL");
			add_location(input0, file, 17, 1, 976);
			attr_dev(div1, "class", "mc-field-group");
			add_location(div1, file, 14, 0, 866);
			attr_dev(label1, "for", "mce-FNAME");
			add_location(label1, file, 20, 1, 1094);
			attr_dev(input1, "type", "text");
			input1.value = "";
			attr_dev(input1, "name", "FNAME");
			attr_dev(input1, "class", "");
			attr_dev(input1, "id", "mce-FNAME");
			add_location(input1, file, 21, 1, 1138);
			attr_dev(div2, "class", "mc-field-group");
			add_location(div2, file, 19, 0, 1064);
			attr_dev(label2, "for", "mce-MMERGE2");
			add_location(label2, file, 24, 1, 1241);
			attr_dev(input2, "type", "text");
			input2.value = "";
			attr_dev(input2, "name", "MMERGE2");
			attr_dev(input2, "class", "");
			attr_dev(input2, "id", "mce-MMERGE2");
			add_location(input2, file, 25, 1, 1285);
			attr_dev(div3, "class", "mc-field-group");
			add_location(div3, file, 23, 0, 1211);
			attr_dev(label3, "class", "svelte-14gdwjs");
			add_location(label3, file, 29, 8, 1492);
			add_location(p0, file, 30, 8, 1542);
			attr_dev(input3, "type", "checkbox");
			attr_dev(input3, "id", "gdpr_42778");
			attr_dev(input3, "name", "gdpr[42778]");
			input3.value = "Y";
			attr_dev(input3, "class", "av-checkbox  svelte-14gdwjs");
			add_location(input3, file, 32, 52, 1765);
			add_location(span2, file, 32, 141, 1854);
			attr_dev(label4, "class", "checkbox subfield svelte-14gdwjs");
			attr_dev(label4, "for", "gdpr_42778");
			add_location(label4, file, 32, 2, 1715);
			attr_dev(fieldset, "class", "mc_fieldset gdprRequired mc-field-group svelte-14gdwjs");
			attr_dev(fieldset, "name", "interestgroup_field");
			add_location(fieldset, file, 31, 8, 1627);
			add_location(p1, file, 34, 8, 1911);
			attr_dev(div4, "class", "content__gdpr");
			add_location(div4, file, 28, 4, 1456);
			attr_dev(a, "href", "https://mailchimp.com/legal/");
			attr_dev(a, "target", "_blank");
			add_location(a, file, 37, 174, 2345);
			add_location(p2, file, 37, 8, 2179);
			attr_dev(div5, "class", "content__gdprLegal");
			add_location(div5, file, 36, 4, 2138);
			attr_dev(div6, "id", "mergeRow-gdpr");
			attr_dev(div6, "class", "mergeRow gdpr-mergeRow content__gdprBlock mc-field-group svelte-14gdwjs");
			add_location(div6, file, 27, 0, 1362);
			attr_dev(div7, "class", "response");
			attr_dev(div7, "id", "mce-error-response");
			set_style(div7, "display", "none");
			add_location(div7, file, 41, 2, 2521);
			attr_dev(div8, "class", "response");
			attr_dev(div8, "id", "mce-success-response");
			set_style(div8, "display", "none");
			add_location(div8, file, 42, 2, 2597);
			attr_dev(div9, "id", "mce-responses");
			attr_dev(div9, "class", "clear");
			add_location(div9, file, 40, 1, 2480);
			attr_dev(input4, "type", "text");
			attr_dev(input4, "name", "b_2d9d55f1ccc764f7d5a16dc0f_9cddddb892");
			attr_dev(input4, "tabindex", "-1");
			input4.value = "";
			add_location(input4, file, 44, 71, 2868);
			set_style(div10, "position", "absolute");
			set_style(div10, "left", "-5000px");
			attr_dev(div10, "aria-hidden", "true");
			add_location(div10, file, 44, 4, 2801);
			...
			add_location(input5, file, 45, 23, 2986);
			attr_dev(div11, "class", "clear");
			add_location(div11, file, 45, 4, 2967);
			attr_dev(div12, "id", "mc_embed_signup_scroll");
			add_location(div12, file, 11, 4, 723);
			...
			attr_dev(form, "class", "validate svelte-14gdwjs");
			attr_dev(form, "target", "_blank");
			form.noValidate = true;
			add_location(form, file, 10, 0, 480);
			attr_dev(div13, "id", "mc_embed_signup");
			add_location(div13, file, 9, 0, 453);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
